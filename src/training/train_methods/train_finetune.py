...
def train_finetune(
    ...
    # Split  data
    high_resource_train, high_resource_val = train_test_split(
    ...
    high_resource_train_loader, high_resource_val_loader = create_dataloaders(
        high_resource_train, high_resource_val, None, config.batch_size
    )
    ...
    best_val_f1 = train_model(high_resource_model, config, high_resource_train_loader, high_resource_val_loader, save_high_resource_model)
    ...
    low_resource_model.load_state_dict(torch.load(save_high_resource_model, weights_only=True))

    best_val_f1 = train_model(low_resource_model, config, low_resource_train_loader, low_resource_val_loader, save_model)
